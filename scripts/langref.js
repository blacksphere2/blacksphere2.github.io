...
function initLangs()
{
	...
	if (langs.length > 0) {
		...
		if (td) {
			// Localizable strings.
			var L_Filter_Tip = "Operating System Filtering";			// tooltip for language button
			var L_Language = "Operating System";		// heading for menu of programming languages
