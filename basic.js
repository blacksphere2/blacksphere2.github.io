...
w('<HTML xmlns:MSIE><style>@media all{MSIE\\:clientCaps {behavior:url(#default#clientcaps);}}</style>')
...
d.write('<a target=_new href="http://v1.nedstatbasic.net/stats?'+id+'"><img src="'+u+'" border=0 width=11 height=11></a>')
}
